...
from scripts.diff_completion_pipeline import DiffCompletion
from datasets.utils.histogram_metrics import compute_hist_metrics 
from datasets.utils.metrics import ChamferDistance, PrecisionRecall, CompletionIoU, RMSE 

PATH_DATA = 'SemanticKitti/dataset/sequences/08'
PATH_GT = 'DiffSSC/var/groundtruth/08'
...
def main(path, voxel_size, max_range, ckpt_path, diff): 
    ...
    seq_map = np.load(f'{PATH_GT}/clean_map.npy')
